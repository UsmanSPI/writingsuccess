  var angularscope = parent.angular.element('#worksheetElem').scope();
       // var angularscope={"answer":"0","validation":""}
      if(!onepage){
					 var img1= new Image();
  ...
  function PrintWithIframe(data)
  {
      ...
      $('html').append('<iframe id="printf" name="printf" style="width:100%;height:1024px;"></iframe>');  // an iFrame is added to the html content, then your div's contents are added to it and the iFrame's content is printed
